  ...
  return (
    <>
      ...
      <div className={`
        ...
        ${isCollapsed ? (isMobile ? '-translate-x-full' : 'w-20') : 'w-80'}
          ...
          <div className="flex items-center justify-between">
            {!isCollapsed && (
              <div className="flex items-center space-x-3">
                <div>
                  <h1 className="text-xl font-bold text-gray-800">Finable</h1>
                  <p className="text-sm text-green-600 font-medium">Crowdfunding Platform</p>
                </div>
              </div>
            )}
            <button 
              ...
              <div key={item.id} className="space-y-1">
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-xl text-left transition-all duration-200 group relative overflow-hidden ${
                    isActive 
                      ? 'bg-green-600 text-white shadow-lg shadow-green-600/25 transform scale-[1.02]' 

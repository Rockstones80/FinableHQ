        ...
        <div className="flex gap-6 text-sm">
          <Link href="/auth/login">
            <Button
              ...
              className="bg-primary py-[9px] px-6 text-white bg-green-600 cursor-pointer font-semibold shadow-md rounded-sm transition-transform hover:-translate-y-1"
            />
          </Link>
          <Link href="/donate">
            <Button
              ...
              className="ring-1 ring-green-600 py-[9px] px-6 cursor-pointer shadow-md font-semibold rounded-sm transition-transform hover:-translate-y-1 text-gray-600"
            />
          </Link>
        </div>

...
export default function BlogPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white">
        {/* Subtle geometric background - FIXED: Added pointer-events-none */}
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Subtle background pattern - FIXED: Added pointer-events-none and reduced z-index */}
      ...
      {/* FIXED: Removed pt-24 since layout now handles spacing */}
      <main className="relative z-10 px-6 lg:px-12 py-16">
        ...
        {/* Empty State for when there are no posts at all */}
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 leading-relaxed">
                We&apos;re working on bringing you amazing educational content. Check back soon for inspiring stories and insights!
              </p>
            </div>
          </motion.div>
        )}

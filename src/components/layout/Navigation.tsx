  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <ul className="lg:flex gap-10 font-semibold text-gray-600 text-sm hidden font-Nunito">
          <Link
            href="/browse"
        ...
        <div className="lg:flex gap-6 text-gray-600 justify-center items-center hidden font-semibold">
          {!isLoggedIn ? (
            <>
              <button 
                onClick={handleLogin}
                className="cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-gray-600 after:transition-all after:duration-500 hover:after:w-full"
              >
                Login
              </button>
              <div>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 text-gray-800 hover:text-gray-900 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors duration-200"
              >
              ...
              {activeDropdown === 'userMenu' && (
                <div className="absolute top-full right-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-gray-100 py-1 z-50">
                  ...
                  <Link href="/dashboard" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                    <User className="w-4 h-4" />
                    My Dashboard
                  </Link>
                  <Link href="/campaigns" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                    <Heart className="w-4 h-4" />
                    My Campaigns
                  </Link>
                  <Link href="/donations" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                    <CreditCard className="w-4 h-4" />
                    Donation History
                  </Link>
                  <Link href="/notifications" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                    <Bell className="w-4 h-4" />
                    Notifications
                  </Link>
                  <Link href="/settings" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
            ...
            {!isLoggedIn ? (
              ...
              <div className="px-6 mt-6">
                ...
                <div className="space-y-3">
                  <Link href="/dashboard" className="flex items-center gap-3 text-gray-600 text-sm" onClick={closeMenu}>
                    <User className="w-4 h-4" />
                    My Dashboard
                  </Link>
                  <Link href="/campaigns" className="flex items-center gap-3 text-gray-600 text-sm" onClick={closeMenu}>
                    <Heart className="w-4 h-4" />
                    My Campaigns
                  </Link>
                  <Link href="/donations" className="flex items-center gap-3 text-gray-600 text-sm" onClick={closeMenu}>
                    <CreditCard className="w-4 h-4" />
                    Donation History
                  </Link>
                  <Link href="/settings" className="flex items-center gap-3 text-gray-600 text-sm" onClick={closeMenu}>
                    <Settings className="w-4 h-4" />
                    Account Settings
                  </Link>
                  <button 
